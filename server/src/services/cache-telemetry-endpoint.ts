// Cache Telemetry endpoint service
// In-memory per-instance telemetry that resets on restart
...
const statsByEndpoint = new Map<string, EndpointStats>();
...
function cleanupOldEndpoints(): void {
...
export function getCacheTelemetrySnapshot(): TelemetrySnapshot {
