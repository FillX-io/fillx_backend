/**
 * OG Story Image Generator Service
 * Generates an SVG image (1200x630) for social media previews.
 */
...
export function generateOgStory(params: OgStoryParams): string {
  ...
  const largeArc = scoreNum !== null && scoreNum > 50 ? 1 : 0;
  ...
  <text x="60" y="610" font-family="system-ui, sans-serif" font-size="14" fill="#555"
    >app.pacifica.fi &middot; ${dateStr} &middot; Free &amp; open source</text>
</svg>`;
